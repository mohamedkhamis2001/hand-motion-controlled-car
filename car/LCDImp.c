...
void ShiftCursorDisplay(u8 SetShiftCursorDisplay, u8 ShiftLeftorRight)
{
    ...
    SetPinValue(PA, pin4, LOW);
    SetPinValue(PA, pin5, LOW);
    SetPinValue(PA, pin6, ShiftLeftorRight);
    SetPinValue(PA, pin7, SetShiftCursorDisplay);
...
void SetPosition(u8 SetLine,u8 SetCharacter)
{
    ...
    {
    case LCD1Line:
        SetCharacter = SetCharacter > 0xf ? 0xf : SetCharacter;
        break;
    case LCD2Line:
        SetCharacter = SetCharacter > 0xf ? 0x4f : SetCharacter + 0x40;
        break;
    default:
        break;
    }
